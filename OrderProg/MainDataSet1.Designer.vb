...
Partial Public Class MainDataSet1
    ...
    Partial Public Class OrdersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddOrdersRow(ByVal ID As Integer, ByVal CustomerID As Integer, ByVal Total As Decimal, ByVal _Date As Date) As OrdersRow
            Dim rowOrdersRow As OrdersRow = CType(Me.NewRow,OrdersRow)
            Dim columnValuesArray() As Object = New Object() {ID, CustomerID, Total, _Date}
...
Namespace MainDataSet1TableAdapters
    ...
    Partial Public Class OrdersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Orders] WHERE (([ID] = @Original_ID) AND ([CustomerID] = @Orig"& _ 
                "inal_CustomerID) AND ((@IsNull_Total = 1 AND [Total] IS NULL) OR ([Total] = @Ori"& _ 
                "ginal_Total)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_"& _ 
                "Date)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Orders] ([ID], [CustomerID], [Total], [Date]) VALUES (@ID, @Cu"& _ 
                "stomerID, @Total, @Date);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, CustomerID, Total, Date FROM Orders WHERE "& _ 
                "(ID = @ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Orders] SET [ID] = @ID, [CustomerID] = @CustomerID, [Total] = @Tota"& _ 
                "l, [Date] = @Date WHERE (([ID] = @Original_ID) AND ([CustomerID] = @Original_Cus"& _ 
                "tomerID) AND ((@IsNull_Total = 1 AND [Total] IS NULL) OR ([Total] = @Original_To"& _ 
                "tal)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)));"& _ 
                ""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, CustomerID, Total, Date FROM Orders WHERE (ID = @ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, CustomerID, Total, Date FROM dbo.Orders"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT ID, CustomerID, Total, Date FROM Orders"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"where ID = @OrderID"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@OrderID", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As MainDataSet1.OrdersDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As MainDataSet1.OrdersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As MainDataSet1.OrdersDataTable = New MainDataSet1.OrdersDataTable()
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As MainDataSet1.OrdersDataTable, ByVal OrderID As Integer) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal OrderID As Integer) As MainDataSet1.OrdersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(OrderID,Integer)
            Dim dataTable As MainDataSet1.OrdersDataTable = New MainDataSet1.OrdersDataTable()
            Me.Adapter.Fill(dataTable)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As MainDataSet1.OrdersDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_CustomerID As Integer, ByVal Original_Total As Global.System.Nullable(Of Decimal), ByVal Original_Date As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal ID As Integer, ByVal CustomerID As Integer, ByVal Total As Global.System.Nullable(Of Decimal), ByVal _Date As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ID As Integer, ByVal CustomerID As Integer, ByVal Total As Global.System.Nullable(Of Decimal), ByVal _Date As Global.System.Nullable(Of Date), ByVal Original_ID As Integer, ByVal Original_CustomerID As Integer, ByVal Original_Total As Global.System.Nullable(Of Decimal), ByVal Original_Date As Global.System.Nullable(Of Date)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CustomerID As Integer, ByVal Total As Global.System.Nullable(Of Decimal), ByVal _Date As Global.System.Nullable(Of Date), ByVal Original_ID As Integer, ByVal Original_CustomerID As Integer, ByVal Original_Total As Global.System.Nullable(Of Decimal), ByVal Original_Date As Global.System.Nullable(Of Date)) As Integer
            Return Me.Update(Original_ID, CustomerID, Total, _Date, Original_ID, Original_CustomerID, Original_Total, Original_Date)
        End Function
    End Class

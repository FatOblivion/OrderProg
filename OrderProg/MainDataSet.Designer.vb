...
Partial Public Class MainDataSet
    ...
    Partial Public Class ProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddProductsRow(ByVal ID As Integer, ByVal Description As String, ByVal Price As Decimal) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            Dim columnValuesArray() As Object = New Object() {ID, Description, Price}
...
Namespace MainDataSetTableAdapters
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ID], [Description], [Price]) VALUES (@ID, @Descrip"& _ 
                "tion, @Price);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, Description, Price FROM Products WHERE (ID = @ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [ID] = @ID, [Description] = @Description, [Price] = @"& _ 
                "Price WHERE (([ID] = @Original_ID) AND ((@IsNull_Price = 1 AND [Price] IS NULL) "& _ 
                "OR ([Price] = @Original_Price)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, Description, Price FROM Products W"& _ 
                "HERE (ID = @ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Description, Price FROM dbo.Products"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As MainDataSet.ProductsDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As MainDataSet.ProductsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As MainDataSet.ProductsDataTable = New MainDataSet.ProductsDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As MainDataSet.ProductsDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Price As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal ID As Integer, ByVal Description As String, ByVal Price As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ID As Integer, ByVal Description As String, ByVal Price As Global.System.Nullable(Of Decimal), ByVal Original_ID As Integer, ByVal Original_Price As Global.System.Nullable(Of Decimal)) As Integer
            ...
            If (Original_Price.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_Price.Value,Decimal)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Description As String, ByVal Price As Global.System.Nullable(Of Decimal), ByVal Original_ID As Integer, ByVal Original_Price As Global.System.Nullable(Of Decimal)) As Integer
            Return Me.Update(Original_ID, Description, Price, Original_ID, Original_Price)
        End Function
    End Class
